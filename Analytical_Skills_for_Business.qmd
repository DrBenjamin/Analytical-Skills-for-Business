...
- [**n8n**](https://app.n8n.cloud/dashboard)
  ...
  - Follow these short introductions to n8n workflows:
      ...
      - In late 2025 there was a free [n8n certification
        course](https://docs.n8n.io/courses/level-one/) added to the n8n documentation. The students can achieve a certificate of completion for this course as part of this class (see an example [Certificate of Completion](./topics/Certificate_of_Completion_n8n.pdf)).
...
To set up the working directory use `getwd()` to show the current and `setwd()`
to set a new working directory. For help,
use the commands `?`, `??` and `help` to read the help pages:

```{r r_setup, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE, eval=FALSE}
...
```{r r_calculation, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r data_assigning, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
![**Source:** *KNIME*](./topics/Descriptive%20statistics/data_analysis.png)
...
```{r categorical_data_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE, fig.width=10, fig.height=8}
# Loading necessary libraries
library(tidyverse)
...
```{r bar_chart_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r pie_chart_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r stacked_bar_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r treemap_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(treemap)
...
```{r mosaic_plot_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r numeric_data_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r histogram_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r boxplot_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r violin_plot_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r scatter_plot_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r line_graph_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r heatmap_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
library(reshape2)
...
```{r time_series_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r line_chart_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r area_chart_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
ggplot(time_series_data, aes(x = date, y = value)) +
...
```{r candlestick_chart_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
```{r seasonal_plot_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
library(lubridate)
...
```{r autocorrelation_plot_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
acf(time_series_data$value, main = "Autocorrelation Plot")
```

- **Control charts**: Monitor process stability and detect anomalies

```{r control_chart_example, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
library(ggplot2)
...
The are several R packages and functions designed to facilitate data cleaning tasks:
...
```{r example_correlation, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
# Loading necessary libraries
library(ourdata)
library(dplyr)
...
```{r example_regression, echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
# Loading necessary libraries
library(ourdata)
library(dplyr)
