...
- [n8n](https://app.n8n.cloud/dashboard)
  - Follow this short introduction to n8n:
    ...
    5. Add a new node and select "Convert to File"
    6. See what other possibilities n8n offers you to wrangle the data
    You can also import the [n8n workflow](https://minio.seriousbenentertainment.org:9000/data/Data%20downloading.json) with the context menu on the top right of the workflow page (...) - `Import from File...` or `Import from URL...`.
