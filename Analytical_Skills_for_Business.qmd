...
-   [**QGIS**](https://qgis.org)
  - Follow these short introductions to QGIS:
    ...
    4. Install the plugin "QGIS GeoNode" via the Plugin Manager via the menu `Plugins` -> `Manage and Install Plugins...`
    5. Open the [MASDAP website](https://www.masdap.mw/developer/) and copy the details for WFS connections.
    6. Open the Data Source Manager via the menu `Layer` -> `Data Source Manager...` or via the icon on the left toolbar and choose GeoNode Plugin.
    7. Create a new connection with the details from the MASDAP website and load the layers.
...
-   [**Tableau**](https://www.tableau.com/)
  - Follow these short introductions to Tableau:
    ...
    2. Download the sample data from [here](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page)
